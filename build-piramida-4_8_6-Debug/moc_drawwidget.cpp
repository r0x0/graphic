...
#include "../piramida/core/drawwidget.h"
...
static const char qt_meta_stringdata_DrawWidget[] = {
    "DrawWidget\0\0angle\0xRotationChanged(int)\0"
    "yRotationChanged(int)\0zRotationChanged(int)\0"
    "setZRotation(int)\0setYRotation(int)\0"
    "setXRotation(int)\0"
};
...
const QMetaObjectExtraData DrawWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DrawWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_DrawWidget,
      qt_meta_data_DrawWidget, &staticMetaObjectExtraData }
};
...
void *DrawWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGLFunctions"))
        return static_cast< QGLFunctions*>(const_cast< DrawWidget*>(this));
...
// SIGNAL 0
void DrawWidget::xRotationChanged(int _t1)
{
...
// SIGNAL 1
void DrawWidget::yRotationChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void DrawWidget::zRotationChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
